            ...
            'lenet-acceleration': {
                ...
                description: (
                    <>
                        ...
                        <p className="mb-5">
                            To optimize performance, I used CUDA based parallel computing to accelerate the LeNet-5 CNN model. The LeNet-5 architecture consists of two convolutional layers, two subsampling layers, and three fully connected layers. By parallelizing the convolutional and subsampling layers, I achieved a 10x speedup in training time compared to CPU-based implementations. I utilized the Nsight-Compute profiler to analyze the GPU kernel performance and identify bottlenecks in memory access and thread synchronization.
